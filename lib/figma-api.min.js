...
"use strict";var __assign=this&&this.__assign||function(){return(__assign=Object.assign||function(t){for(var e,n=1,i=arguments.length;n<i;n++)for(var s in e=arguments[n])Object.prototype.hasOwnProperty.call(e,s)&&(t[s]=e[s]);return t}).apply(this,arguments)},__awaiter=this&&this.__awaiter||function(t,e,n,i){return new(n||(n=Promise))(function(s,r){function o(t){try{u(i.next(t))}catch(t){r(t)}}function a(t){try{u(i.throw(t))}catch(t){r(t)}}function u(t){t.done?s(t.value):new n(function(e){e(t.value)}).then(o,a)}u((i=i.apply(t,e||[])).next())})},__generator=this&&this.__generator||function(t,e){var n,i,s,r,o={label:0,sent:function(){if(1&s[0])throw s[1];return s[1]},trys:[],ops:[]};return r={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(r[Symbol.iterator]=function(){return this}),r;function a(r){return function(a){return function(r){if(n)throw new TypeError("Generator is already executing.");for(;o;)try{if(n=1,i&&(s=2&r[0]?i.return:r[0]?i.throw||((s=i.return)&&s.call(i),0):i.next)&&!(s=s.call(i,r[1])).done)return s;switch(i=0,s&&(r=[2&r[0],s.value]),r[0]){case 0:case 1:s=r;break;case 4:return o.label++,{value:r[1],done:!1};case 5:o.label++,i=r[1],r=[0];continue;case 7:r=o.ops.pop(),o.trys.pop();continue;default:if(!(s=(s=o.trys).length>0&&s[s.length-1])&&(6===r[0]||2===r[0])){o=0;continue}if(3===r[0]&&(!s||r[1]>s[0]&&r[1]<s[3])){o.label=r[1];break}if(6===r[0]&&o.label<s[1]){o.label=s[1],s=r;break}if(s&&o.label<s[2]){o.label=s[2],o.ops.push(r);break}s[2]&&o.ops.pop(),o.trys.pop();continue}r=e.call(t,o)}catch(t){r=[6,t],i=0}finally{n=s=0}if(5&r[0])throw r[1];return{value:r[0]?r[1]:void 0,done:!0}}([r,a])}}},__importDefault=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var api_funcs_1=require("./api-funcs"),axios_1=__importDefault(require("axios")),utils_1=require("./utils"),Api=function(){return function(t){var e=this;this.appendHeaders=function(t){e.personalAccessToken&&(t["X-Figma-Token"]=e.personalAccessToken),e.oAuthToken&&(t.Authorization="Bearer "+e.oAuthToken)},this.request=function(t,n){return __awaiter(e,void 0,void 0,function(){var e,i,s;return __generator(this,function(r){switch(r.label){case 0:return e={},this.appendHeaders(e),i=__assign({url:t},n,{headers:e}),[4,axios_1.default(i)];case 1:if(s=r.sent(),2!==Math.floor(s.status/100))throw s.statusText;return[2,s.data]}})})},this.getFile=api_funcs_1.getFileApi,this.getFileNodes=api_funcs_1.getFileNodesApi,this.getImage=api_funcs_1.getImageApi,this.getImageFills=api_funcs_1.getImageFillsApi,this.getComments=api_funcs_1.getCommentsApi,this.postComment=api_funcs_1.postCommentsApi,this.getMe=api_funcs_1.getUserMeApi,this.getVersions=api_funcs_1.getVersionsApi,this.getTeamProjects=api_funcs_1.getTeamProjectsApi,this.getProjectFiles=api_funcs_1.getProjectFilesApi,this.getTeamComponents=api_funcs_1.getTeamComponentsApi,this.getComponent=api_funcs_1.getComponentApi,this.getTeamStyles=api_funcs_1.getTeamStylesApi,this.getStyle=api_funcs_1.getStyleApi,"personalAccessToken"in t&&(this.personalAccessToken=t.personalAccessToken),"oAuthToken"in t&&(this.oAuthToken=t.oAuthToken)}}();function oAuthLink(t,e,n,i,s){return"https://www.figma.com/oauth?"+utils_1.toQueryParams({client_id:t,redirect_uri:e,scope:n,state:i,response_type:s})}function oAuthToken(t,e,n,i,s){return __awaiter(this,void 0,void 0,function(){var r,o,a;return __generator(this,function(u){switch(u.label){case 0:return r=utils_1.toQueryParams({client_id:t,client_secret:e,redirect_uri:n,code:i,grant_type:s}),o="https://www.figma.com/api/oauth/token?"+r,[4,axios_1.default({url:o,method:"POST"})];case 1:if(200!==(a=u.sent()).status)throw a.statusText;return[2,a.data]}})})}exports.Api=Api,exports.oAuthLink=oAuthLink,exports.oAuthToken=oAuthToken;

},{"./api-funcs":2,"./utils":6,"axios":7}],2:[function(require,module,exports){
"use strict";var __assign=this&&this.__assign||function(){return(__assign=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var o in t=arguments[i])Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o]);return e}).apply(this,arguments)};Object.defineProperty(exports,"__esModule",{value:!0});var config_1=require("./config"),utils_1=require("./utils");function getFileApi(e,t){var i=utils_1.toQueryParams(t);return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/files/"+e+"?"+i)}function getFileNodesApi(e,t,i){var s=utils_1.toQueryParams(__assign({},i,{ids:t.join(",")}));return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/files/"+e+"/nodes?"+s)}function getImageApi(e,t){var i=utils_1.toQueryParams(t);return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/images/"+e+"?"+i)}function getImageFillsApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/files/"+e+"/images")}function getCommentsApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/files/"+e+"/comments")}function postCommentsApi(e,t,i){var s={message:t,client_meta:i};return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/files/"+e+"/comments",{method:"POST",data:JSON.stringify(s)})}function getUserMeApi(){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/me")}function getVersionsApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/files/"+e+"/versions")}function getTeamProjectsApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/teams/"+e+"/projects")}function getProjectFilesApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/projects/"+e+"/files")}function getTeamComponentsApi(e,t){void 0===t&&(t={});var i=utils_1.toQueryParams(t);return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/teams/"+e+"/components?"+i)}function getComponentApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/components/"+e)}function getTeamStylesApi(e,t){void 0===t&&(t={});var i=utils_1.toQueryParams(t);return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/teams/"+e+"/styles?"+i)}function getStyleApi(e){return this.request(config_1.API_DOMAIN+"/"+config_1.API_VER+"/styles/"+e)}exports.getFileApi=getFileApi,exports.getFileNodesApi=getFileNodesApi,exports.getImageApi=getImageApi,exports.getImageFillsApi=getImageFillsApi,exports.getCommentsApi=getCommentsApi,exports.postCommentsApi=postCommentsApi,exports.getUserMeApi=getUserMeApi,exports.getVersionsApi=getVersionsApi,exports.getTeamProjectsApi=getTeamProjectsApi,exports.getProjectFilesApi=getProjectFilesApi,exports.getTeamComponentsApi=getTeamComponentsApi,exports.getComponentApi=getComponentApi,exports.getTeamStylesApi=getTeamStylesApi,exports.getStyleApi=getStyleApi;
