...
var Api = /** @class */ (function () {
    function Api(params) {
        ...
        this.getImage = ApiEndpoints.getImagesApi;
        ...
        this.deleteComments = ApiEndpoints.deleteCommentApi;
        this.getMe = ApiEndpoints.getUserMeApi;
        this.getVersions = ApiEndpoints.getFileVersionsApi;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, axios_1.default)({ url: url, method: 'POST', headers: headers })];
                case 1:
                    res = _a.sent();
                    if (res.status !== 200)
                        throw res.statusText;
...
},{"./api-endpoints":2,"./utils":5,"axios":6,"buffer":39}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../adapters/http":7,"../adapters/xhr":7,"../core/AxiosError":13,"../helpers/normalizeHeaderName":30,"../helpers/toFormData":35,"../utils":37,"./env/FormData":31,"./transitional":21,"_process":41}],21:[function(require,module,exports){
'use strict';
