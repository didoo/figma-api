...
var Api = /** @class */ (function () {
    function Api(params) {
        ...
        this.watchVersion = function (key, onNewVersion, opts) {
            if (opts === void 0) { opts = {
                timeout: 6000,
            }; }
            var currentPromise;
            ...
            var interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!!currentPromise) return [3 /*break*/, 8];
                        ...
                        case 2:
                            ...
                            if (!!lastVersionId) return [3 /*break*/, 5];
                        ...
                        case 5: return [4 /*yield*/, onNewVersion(lastVer)];
                        case 6:
                            _b.sent();
                            _b.label = 7;
                        case 7:
        ...
        this.watchComments = function (key, onNewComments, opts) {
            if (opts === void 0) { opts = {
                timeout: 5000,
            }; }
            var currentPromise;
...
function oAuthToken(client_id, client_secret, redirect_uri, code, grant_type) {
    ...
    return go_result_js_1.ResultA(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, go_result_js_1.ResultA(axios_1.default({ url: url }))];
                case 1:
                    _a = _b.sent(), err = _a[0], res = _a[1];
                    if (err || !res || res.status !== 200)
