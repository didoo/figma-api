...
var Api = /** @class */ (function () {
    function Api(params) {
        ...
        this.request = function (url, opts, headers) { return __awaiter(_this, void 0, void 0, function () {
            var axiosParams, res;
...
comment_id) {
     ...
     * (see `this.appendHeaders` in api-class.ts) will use the default 'url-www-endoded' content-type */
    return this.request(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + fileKey + "/comments", {
        method: 'POST',
