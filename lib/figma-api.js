...
var Api = /** @class */ (function () {
    function Api(params) {
        ...
        this.request = function (url, opts) { return go_result_js_1.ResultA(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
...
function oAuthToken(client_id, client_secret, redirect_uri, code, grant_type) {
    ...
    return go_result_js_1.ResultA(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
        var a;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default({ url: url })];
                case 1:
                    a = _a.sent();
                    if (a.status !== 200)
                        resolve(new ApiError(a));
                    else
                        resolve(a.data);
                    return [2 /*return*/];
            }
...
},{"./config":3,"axios":5,"go-result-js":30}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var ImageType;
(function (ImageType) {
...
},{"./api":1,"./ast-types":2,"./config":3}],5:[function(require,module,exports){
